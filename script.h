...
class scene //клас сцена - в якому зберігається вся інформація про сцену
{
public:
    void set(int ls, string n, string text); //функція виводу репліки, що приймає номер сцени, та два рядка, що треба вивести на екран
